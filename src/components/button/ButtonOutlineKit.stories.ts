...
import ButtonOutlineKit from '@/components/button/ButtonOutlineKit.vue'

const meta: Meta<typeof ButtonOutlineKit> = {
  title: 'Buttons/Outline',
  component: ButtonOutlineKit,
  tags: ['autodocs'],
  args: {
    type: 'button',
    color: 'primary',
